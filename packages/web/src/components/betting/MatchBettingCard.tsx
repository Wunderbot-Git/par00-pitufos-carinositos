...
export function MatchBettingCard({ match, userBet, onClick }: Props) {
    ...
    return (
        <div
            onClick={onClick}
            className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 relative overflow-hidden transition-all active:scale-[0.98] cursor-pointer"
        >
            <div className="flex justify-between items-center mb-3">
                ...
                <div className="flex items-center gap-1.5 text-xs font-medium">
                    {match.currentHole === 0 ? (
                        ...
                        <span className="text-slate-500 bg-slate-100 px-2 py-0.5 rounded-full">Finalizada</span>
                    ) : (
