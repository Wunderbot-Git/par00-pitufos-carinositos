                ...
                <>
                    <div className="grid grid-cols-2 gap-2 text-center mb-3">
                        <div className="bg-slate-700/50 rounded-lg p-2">
                            <div className="text-[10px] text-slate-400 uppercase tracking-wider mb-1">Total Apostado</div>
                    ...
                    {/* Posible Ganancia — hero highlight */}
                    <div className="bg-amber-500/15 border border-amber-500/30 rounded-lg p-3 flex items-center justify-between">
                        <div className="text-[10px] text-amber-200/80 uppercase tracking-wider font-bold">Lo que te puedes ganar</div>
                        <div className="text-lg font-black text-amber-400">{formatCurrency(stats.potential)}</div>
                    </div>
